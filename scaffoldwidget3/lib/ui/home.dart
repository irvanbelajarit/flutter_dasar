  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      bottomNavigationBar: new BottomNavigationBar(items: [
        new BottomNavigationBarItem(icon: new Icon(Icons.add),label: 'Hello'),
        new BottomNavigationBarItem(icon: new Icon(Icons.print),label: 'World'),
        new BottomNavigationBarItem(icon: new Icon(Icons.call_missed),label: 'Flutter')
      ],onTap: (int i)=> debugPrint("Nav Button $i Di tekan "),),
